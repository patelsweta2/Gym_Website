    ...
    <>
        ...
        <div className="container">
          ...
          <div className="flex flex-col text-center items-center relative">
            ...
            <img
              src={TitleRed}
              alt="text_bg"
              className="width-[24rem] absolute -top-[10px] "
            />
          ...
          <div className="grid grid-cols-4 grid-rows-2 gap-7 h-full mt-7 md1000:flex md1000:flex-col">
            <div className="item-0-div relative">
              <div className="item-0 ease-in duration-[.4s] p-6"></div>
            ...
            <div className="item-1-div relative">
              <div className="item-1 ease-in duration-[.4s] p-6"></div>
              <div className="absolute z-10 bottom-10 left-10">
            ...
            <div className="item-2-div relative">
              <div className="item-2 ease-in duration-[.4s] p-6"></div>
              <div className="absolute z-10 bottom-10 left-10">
            ...
            <div className="item-3-div relative">
              <div className="item-3 ease-in duration-[.4s] p-6"></div>
              <div className="absolute z-10 bottom-10 left-10">
      ...
      <div className="featured-cta flex justify-center text-left items-center md1000:bg-none md1000:bg-[#ff0336]">
        <div className="container page-padding">
          <div className="flex items-center md1000:flex-col md1000:text-center">
