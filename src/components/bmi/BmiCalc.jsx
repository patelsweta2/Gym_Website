      ...
      <section className="bmi-section py-[6rem] relative">
        <div className="container page-padding">
          ...
          <div className="text-white w-[52rem] min620:w-[100%] relative">
            ...
            <p className="text-[16px] text-[#b19e9e] min620:text-white">
              Accurately measure your body mass index with our convenient
              calculator.
            </p>
            <div className="flex flex-col">
              <form className="flex w-full gap-6 h-[50px] mt-10">
                <input
                  ...
                  className="w-[50%] bg-white text-[14px] border-2 text-[#202020] border-[#2725257d] pl-6 min450:bg-white min450:text-black"
