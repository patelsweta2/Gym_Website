    ...
    <>
      ...
      >
        <div className="container-hero">
          <div className="flex flex-col text-white absolute hero-text min800:items-center min800:-right-[22rem] min620:-right-[20rem] min800:w-[80%] min540:-right-[17rem] min450:-right-[14rem] min375:-right-[11rem]">
          ...
          {/* socials  */}
          <div className="flex flex-row-reverse -rotate-90 text-white absolute top-2/4 right-0 items-center min800:hidden">
            ...
            <div className="text-white gap-7 flex mr-7">
              <i className="fa-brands rotate-90 hover:text-[#ff0336] fa-facebook text-3xl cursor-pointer ease-in duration-200" />
              <i className="fa-brands rotate-90 hover:text-[#ff0336] fa-twitter text-3xl cursor-pointer ease-in duration-200" />
              <i className="fa-brands rotate-90 hover:text-[#ff0336] fa-linkedin-in text-3xl cursor-pointer ease-in duration-200" />
            </div>
          </div>
        </div>
      </section>
